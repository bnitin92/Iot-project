/* 
[x86]
gcc -c deamon_hw_harden.c -o simpled.o
gcc -o simpled simpled.o
Check syslog: tail /var/log/syslog

[arm]
${BUILDROOT_HOME}/output/host/usr/bin/arm-linux-gcc --sysroot=${BUILDROOT_HOME}/output/staging  -c deamon_hw_harden.c -o simpled.o
...
int main(void) {
	...
	chmod("var/log/messages",S_IRUSR | S_IRGRP | S_IROTH);
